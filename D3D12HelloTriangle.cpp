...
void D3D12HelloTriangle::LoadAssets()
{
	...
	// Create the vertex buffer.
	{
		...
		Vertex triangleVertices[] = {
			// Top
			{{-r, r + h, -r}, {black[0], black[1], black[2], black[3]}},
			{{r, r + h, -r},  {black[0], black[1], black[2], black[3]}},
			{{-r,  r + h, r},  {white[0], white[1], white[2], white[3]}},
			{{r,  r + h, r},  {white[0], white[1], white[2], white[3]}},
			// Bottom
			{{-r, -r + h, -r}, {white[0], white[1], white[2], white[3]}},
			{{r, -r + h, -r},  {white[0], white[1], white[2], white[3]}},
		...
		// std::vector<UINT> indices = {0,1,2,2,3,1,4,5,6,6,7,5,8,9,10,10,11,9,12,13,14,14,15,13,16,17,18,18,19,17,20,21,22,22,23,21};
		std::vector<UINT> indices = {0,1,2, 1,3,2, 6,5,4, 6,7,5, 8,9,10, 9,11,10, 14,13,12, 14,15,13, 18,17,16, 18,19,17, 20,21,22, 21,23,22};
...
{ 
	...
	AccelerationStructureBuffers bottomLevelBuffers = CreateBottomLevelAS({{m_vertexBuffer.Get(), 4}}, {{m_indexBuffer.Get(), 36}});
...
void D3D12HelloTriangle::CreatePlaneVB() {
	...
	Vertex planeVertices[] = {
		{{-size, h,  size}, {white[0], white[1], white[2], white[3]}}, // 0 
		{{-size, h, -size}, {black[0], black[1], black[2], black[3]}}, // 1 
		{{ size, h,  size}, {white[0], white[1], white[2], white[3]}}, // 2 
		{{ size, h,  size}, {white[0], white[1], white[2], white[3]}}, // 2 
		{{-size, h, -size}, {black[0], black[1], black[2], black[3]}}, // 1 
		{{ size, h, -size}, {black[0], black[1], black[2], black[3]}} // 4 
	};
