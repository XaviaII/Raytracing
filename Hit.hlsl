...
{ 
    ...
    float3 color = float3(1.f, 1.f, 1.f) * barycentrics.x + float3(0.f, 0.f, 0.f) * barycentrics.y + float3(1.f, 1.f, 1.f) * barycentrics.z;

    float4 hitColor = float4(color * factor, RayTCurrent());
